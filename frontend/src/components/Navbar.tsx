  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-background/70 border-b border-border/40">
      <nav className="max-w-7xl mx-auto px-6 lg:px-5 h-16 flex items-center justify-between">
        ...
        <a href={socials.Resume} target="_blank" rel="noreferrer" className="border border-primary/40 bg-primary/5 backdrop-blur px-5 py-2 rounded-xl font-medium text-foreground transition-smooth hover:border-primary hover:bg-primary/10">
          Resume
        </a>
      </nav>
